...
/*   Updated: 2023/01/18 15:38:50 by wnaseeve         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//char	*final(char *buf, int r_read, char *line, char *stash)
//{
//	free(buf);
//	if (r_read == -1)
//		return (NULL);
...
/*
	...
	NOTE = volontairement enlever le if (!buf) return NULL; pour norminette
